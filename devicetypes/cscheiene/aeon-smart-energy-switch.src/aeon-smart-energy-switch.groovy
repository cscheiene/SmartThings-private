 ...
 */
metadata {
	definition (name: "Aeon Smart Energy Switch", namespace: "cscheiene", author: "jabbera,cscheiene") {
	...
	tiles {
		...
		valueTile("main", "device.power", decoration: "flat", canChangeIcon: true) {
...
def configureAfterSecure() {
	...
	secureSequence([
		...
		zwave.configurationV1.configurationSet(parameterNumber: 91, size: 2, scaledConfigurationValue: 50),	// The value here represents minimum change in wattage (in terms of wattage) for a REPORT to be sent (Valid values 0‐ 60000).
		zwave.configurationV1.configurationSet(parameterNumber: 92, size: 1, scaledConfigurationValue: 60),	// The value here represents minimum change in wattage percent (in terms of percentage) for a REPORT to be sent (Valid values 0‐100).
		...
		zwave.configurationV1.configurationSet(parameterNumber: 111, size: 4, scaledConfigurationValue: 5),	// The time interval of sending Report group 1 (Valid values 0x01‐0xFFFFFFFF).
		...
		zwave.configurationV1.configurationSet(parameterNumber: 112, size: 4, scaledConfigurationValue: 600),	// The time interval of sending Report group 2 (Valid values 0x01‐0xFFFFFFFF).
