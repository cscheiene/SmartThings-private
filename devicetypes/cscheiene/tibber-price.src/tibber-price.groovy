 ...
 */
metadata {
	definition (name: "Tibber Price", namespace: "cscheiene", author: "tibberdev, cscheiene", mnmn: "SmartThingsCommunity", vid: "07e39779-6492-314f-a20c-09d4aa0d90ef", ocfDeviceType: "x.com.st.d.energymeter") {
		capability "Sensor"
        ...
        try {
            httpPostJson(params) { resp ->
                if(resp.status == 200){
                    ...
                    def consumption = resp.data.data.viewer.homes[0].timeZone
                    ...
                    sendEvent(name: "consumption", value: state.consumption)
...
def parse(String description) {
    ...
    def eventMap = [
        createEvent(name: "consumption", value: state.consumtion)
