...
metadata {
	definition (name: "Robomow", namespace: "cscheiene", author: "SmartThings", ocfDeviceType: "x.com.st.d.sensor.contact") {
	...
	tiles {
		standardTile("contact", "device.contact", width: 2, height: 2) {
			state "open", label: 'Mowing', icon: "https://image.flaticon.com/icons/png/512/10/10719.png", backgroundColor: "#ffffff"
			state "closed", label: 'Docked', icon: "http://iconshow.me/media/images/ui/ios7-icons/png/512/battery-charging.png", backgroundColor: "#ffffff"
		}
...
def sensorValueEvent(value) {
	if (value) {
		createEvent(name: "contact", value: "open", descriptionText: "$device.displayName is mowing")
	} else {
		createEvent(name: "contact", value: "closed", descriptionText: "$device.displayName is docked")
	}
}
...
def zwaveEvent(physicalgraph.zwave.commands.sensorbinaryv1.SensorBinaryReport cmd)
{
    ...
    log.debug "sensorbinary"
}

def zwaveEvent(physicalgraph.zwave.commands.sensoralarmv1.SensorAlarmReport cmd)
{
	sensorValueEvent(cmd.sensorState)
    log.debug "sensoralarm"
}
...
def zwaveEvent(physicalgraph.zwave.commands.notificationv3.NotificationReport cmd)
{
	...
	if (cmd.notificationType == 0x06 && cmd.event == 0x16) {
        ...
        log.debug "notification1"
	} else if (cmd.notificationType == 0x06 && cmd.event == 0x17) {
		result << sensorValueEvent(0)
        log.debug "notification0"
